...
import { MOCK_NOTES, CaseNote, NoteType } from '@/data/mock-case';
...
export default function CaseNotes() {
  const [notes, setNotes] = useState<CaseNote[]>(MOCK_NOTES);
  ...
  const saveEdit = (id: string) => {
    setNotes(prev => prev.map(n => n.id === id ? { ...n, content: editValue, lastEditedAt: new Date().toISOString() } : n));
