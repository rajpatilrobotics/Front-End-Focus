...
import { UrgentNeed, UrgentNeedStatus, UrgentNeedUrgency } from '@/data/mock-case';
...
export default function CaseSafety() {
  ...
  const needs = state.urgentNeeds;
  const [selectedId, setSelectedId] = useState<string | null>(needs[0]?.id ?? null);
